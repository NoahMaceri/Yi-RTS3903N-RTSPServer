...
int snd_mixer_sbasic_info(const snd_mixer_class_t *class_o, sm_class_basic_t *info);
void *snd_mixer_sbasic_get_private(const snd_mixer_class_t *class_o);
void snd_mixer_sbasic_set_private(const snd_mixer_class_t *class_o, void *private_data);
void snd_mixer_sbasic_set_private_free(const snd_mixer_class_t *class_o, void (*private_free)(snd_mixer_class_t *class_o));
