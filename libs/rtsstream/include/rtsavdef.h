...
enum RTS_AV_FMT {
	...
	RTS_V_FMT_H265 = RTS_PIX_FMT_H265,
...
enum rts_h265_level {
	H265_LEVEL_0 =    0,    //firmware determines a level
	H265_LEVEL_1 =   10,
	H265_LEVEL_2 =   20,
	H265_LEVEL_2_1 = 21,
	H265_LEVEL_3 =   30,
...
struct rts_h265_attr {
	enum rts_h265_level level;
	enum rts_h265_tier tier;
	unsigned int bps;
	unsigned int gop;
	enum rts_av_rotation rotation;
	enum rts_av_mirror mirror;
};
