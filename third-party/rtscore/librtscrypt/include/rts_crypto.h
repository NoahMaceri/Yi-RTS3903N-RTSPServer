...
enum RTS_CIPHER_KEYMODE {
	RTS_CIPHER_KEYMODE_NORMAL = 0,
	RTS_CIPHER_KEYMODE_EFUSE,
};
...
/**
 * Set cipher key mode.
 * Only valid for rlx hw encryption algorithm(aes:128bit key)
 *
 * @param[in] mode    - key mode. default: RTS_CIPHER_KEYMODE_NORMAL
 *
 * @return =0 - success
 *	   <0 - fail
 */
